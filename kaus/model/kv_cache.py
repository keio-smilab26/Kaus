...
def initialize_past_key_values(model, max_length=None):
    """
    ...
    Args:
        ...
        max_length (int, optional): Maximum sequence length for the KV cache. Defaults to
            config.max_position_embeddings if not specified.
